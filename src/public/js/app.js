...
function renderIndex(books) {
    ...
    for (const book of books) {
        ...
        row.classList = 'row mb-5 pt-5 pb-5 bg-warning';
        ...
        // create info items
            ...
            btn.classList = 'btn btn-danger see-more ' + (i % 2 == 0 ? 'float-right' : 'float-left');
...
function renderSingle(book) {
    ...
    // "Go back" button
    let btn = document.createElement('a');
    btn.classList = 'btn btn-danger go-back float-left';
